...
int main(int argc, char const *argv[])
{
    ...
    indiceStampaNodi = 0;
    utenteMax.budget = 0;
    utenteMin.budget = getSoBudgetInit();
    nodoMax.budget = 0;
    nodoMin.budget = getSoBudgetInit();
...
/**/
    ...
    else
    {
        ...
        printf("\nUTENTE[PID] | BILANCIO[INT]\n");
        printf("%09d\t%09d <-- UTENTE con budget MAGGIORE\n", utenteMax.userPid, utenteMax.budget);
        printf("%09d\t%09d <-- UTENTE con budget MINORE\n", utenteMin.userPid, utenteMin.budget);
    }
    if (flag == 1)
    {
    ...
    else
    {
        ...
        printf("%09d\t%09d <-- NODO con budget MAGGIORE\n", nodoMax.nodoPid, nodoMax.budget);
