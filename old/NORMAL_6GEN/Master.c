...
int main(int argc, char const *argv[])
{
    ...
    while (master)
    {
        ...
        if(master && msgrcv(idCodaMessaggiProcessoMaster, &m, sizeof(m.transazione) + sizeof(m.hops), 0, IPC_NOWAIT) > 0)
        {
...
/**/
    ...
    if (getSoUsersNum() < 2000)
    {
        ...
        for (contatoreStampa; contatoreStampa < getSoUsersNum(); contatoreStampa++)
        {
            ...
            /**/
            sommaBudgetUtente += puntatoreSharedMemoryTuttiUtenti[contatoreStampa + 1].budget;
            /**/
        }
    ...
    if (getSoNodesNum() < 200000)
    {
        ...
        for (contatoreStampa; contatoreStampa < puntatoreSharedMemoryTuttiNodi[0].nodoPid; contatoreStampa++)
        {
            ...
            /**/
            sommaBudgetNodi += puntatoreSharedMemoryTuttiNodi[contatoreStampa + 1].budget;
            /**/
        }
